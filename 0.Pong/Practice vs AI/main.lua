...
function love.update(dt)
    fellow1.y=ball.y-fellow1.height/2
      if fellow1.y<=0 then
            fellow1.y=0
        end
        if fellow1.y>=WINDOW_HEIGHT-fellow1.height then
            fellow1.y=WINDOW_HEIGHT-fellow1.height
        end
    fellow2.y=ball.y-fellow2.height/2
        if fellow2.y<=0 then
              fellow2.y=0
          end
          if fellow2.y>=WINDOW_HEIGHT-fellow2.height then
              fellow2.y=WINDOW_HEIGHT-fellow2.height
          end
    if love.keyboard.isDown( 'down' ) then
        fellow2.dy=paddlespeed*dt
    end
